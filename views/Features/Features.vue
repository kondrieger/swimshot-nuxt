<template>
    <div class="container features">
        ...
        <h3 class="media__text">
            Присоединяйтесь к группам в марте 2022!<br />
            ...
            featuresArr: [
                {
                    ...
                    text: 'За эту стоимость ты или твой ребенок можете прочувствовать всю прелесть бассейна и школы плавания Swim Shot, после чего принять решение о покупке абонемента',
                },
                {
                ...
                },
                {
                    ...
                    text: 'Мы проводим уроки в нескольких бассейнах, выбрай наиболее подходящее место и расписание для себя и ребенка',
                },
            ],
            swiperOptions: {
                slidesPerView: 'auto',
