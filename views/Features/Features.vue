    ...
    data() {
        return {
            ...
            featuresArr: [
                ...
                {
                    title: 'Нам не важно, сколько тебе лет',
                    text: 'Мы проводим тренировки для детей с двух лет и взрослых любого возраста и уровня подготовки, и если ты это читаешь, то ты точно нам подходишь :)',
                },
                {
