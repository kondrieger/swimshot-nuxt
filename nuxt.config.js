    ...
    head: {
        ...
        meta: [
            ...
            { name: 'viewport', content: 'width=device-width, initial-scale=1' },
            {
                ...
                name: 'description',
                content:
                    'Научим плавать вас и вашего ребенка. Школа плавания Swim Shot: обучение плаванию детей и взрослых в Зеленограде. Пробное занятие по плаванию всего 300 рублей. Свободное плавание в Зеленограде, бассейн Swim Shot.',
            },
            {
                hid: 'keywords',
                name: 'keywords',
